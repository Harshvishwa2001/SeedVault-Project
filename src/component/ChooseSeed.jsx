...
export default function ChooseSeed() {
    ...
    //         y: 60, // Reduced from 100 for a smoother entrance
    //         opacity: 0,
    ...
    //             start: "top 85%", // Triggers earlier so bottom cards aren't stuck in "blur/invisible" state
    //             toggleActions: "play none none none", // Ensures they stay visible once played
    //         }
    //     });
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-32">
                    {features.map((f, i) => (
                        <div
                            key={i}
                            className="feature-card group relative h-[380px] bg-white rounded-[2.5rem] border border-slate-100 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.02)] hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] transition-all duration-700 hover:-translate-y-4 flex flex-col justify-between p-10 overflow-hidden"
                        >
